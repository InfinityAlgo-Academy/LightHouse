...
const getFilenamePrefix = require('../core/lib/file-namer.js').getFilenamePrefix;
const assetSaver = require('../core/lib/asset-saver.js');
const URL = require('../core/lib/url-shim.js');
...
async function runLighthouseWithFraggleRock(url, flags, config, launchedChrome) {
  const fraggleRock = require('../core/fraggle-rock/api.js');

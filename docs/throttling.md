...
These exact figures are [defined in the Lighthouse constants](https://github.com/GoogleChrome/lighthouse/blob/master/core/config/constants.js#:~:text=of%204G%20connections.-,mobileSlow4G,-%3A%20%7B) and used as Lighthouse's throttling default.

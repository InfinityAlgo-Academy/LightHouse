...
export class PerformanceCategoryRenderer extends CategoryRenderer {
   ...
   */
  _renderMetric(audit) {
    const tmpl = this.dom.cloneTemplate('metric');
  ...
  _renderOpportunity(audit, scale) {
    const oppTmpl = this.dom.cloneTemplate('opportunity');
  ...
  render(category, groups, environment) {
    ...
    const toggleTmpl = this.dom.cloneTemplate('metricsToggle');
    ...
    if (opportunityAudits.length) {
      ...
      const tmpl = this.dom.cloneTemplate('opportunityHeader');

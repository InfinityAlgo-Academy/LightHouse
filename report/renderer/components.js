...
function createFooterComponent(dom) {
  const el0 = dom.createFragment();
  const el1 = dom.createElement('footer', 'lh-footer');
  const el2 = dom.createElement('style');
 ...
 * @param {DOM} dom
 */
function createHeaderComponent(dom) {
  const el0 = dom.createFragment();
  const el1 = dom.createElement('header', 'lh-header');
  const el2 = dom.createElement('style');
  ...
  const el3 = dom.createElement('style');
  ...
  const el4 = dom.createElement('div', 'lh-sticky-header');
  const el5 = dom.createElement('div', 'lh-highlighter');
  el4.append(' ', el5, ' ');
  const el6 = dom.createElement('div', 'lh-static-header');
  const el7 = dom.createElement('div', 'lh-pyro');
  const el8 = dom.createElement('div', 'lh-before');
  const el9 = dom.createElement('div', 'lh-after');
  el7.append(' ', el8, ' ', el9, ' ');
  const el10 = dom.createElement('div', 'lh-static-gauges-wrapper');
  const el11 = dom.createElement('div', 'lh-scorescale-wrap');
  el6.append(' ', el7, ' ', el10, ' ', el11, ' ');
  el1.append(' ', el2, ' ', el3, ' ', el4, ' ', el6, ' ');
  el0.append(el1);
  return el0;
}
...
function createTopbarComponent(dom) {
  const el0 = dom.createFragment();
  const el1 = dom.createElement('div', 'lh-topbar');
  const el2 = dom.createElement('style');
...
/** @typedef {'3pFilter'|'audit'|'categoryHeader'|'chevron'|'clump'|'crc'|'crcChain'|'elementScreenshot'|'footer'|'fraction'|'gauge'|'gaugePwa'|'header'|'metric'|'opportunity'|'opportunityHeader'|'scorescale'|'snippet'|'snippetContent'|'snippetHeader'|'snippetLine'|'styles'|'topbar'|'warningsToplevel'} ComponentName */
/**
 * @param {DOM} dom
...
export function createComponent(dom, componentName) {
  switch (componentName) {
    ...
    case 'header': return createHeaderComponent(dom);

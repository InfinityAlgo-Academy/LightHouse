...
function createTopbarComponent(dom) {
  ...
  const el8 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el8.setAttribute('d', 'M21.07 48h-9.476a.5.5 0 0 1-.492-.586l.563-3.385L34.44 32.641l1.332 8.007zm9.988-24-17.52 8.76 1.36-8.174a.5.5 0 0 0-.49-.586z');
  el8.setAttribute('fill', '#fff');
  el8.setAttribute('opacity', '.4');
  const el9 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el9.setAttribute('d', 'M20 10.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5z');
  el9.setAttribute('fill', '#ff3');
  el6.append(" ",el7," ",el8," ",el9," ");
  el3.append(" ",el4," ",el6," ");
  const el10 = dom.createElement("a", "lh-topbar__url");
  el10.setAttribute('href', '');
  el10.setAttribute('target', '_blank');
  el10.setAttribute('rel', 'noopener');
  const el11 = dom.createElement("div", "lh-tools");
  const el12 = dom.createElement("div", "lh-tools-locale lh-hidden");
  const el13 = dom.createElement("button", "lh-button lh-tool-locale__button");
  el13.setAttribute('id', 'lh-button__swap-locales');
  el13.setAttribute('title', 'Show Language Picker');
  el13.setAttribute('aria-label', 'Toggle language picker');
  el13.setAttribute('aria-haspopup', 'menu');
  el13.setAttribute('aria-expanded', 'false');
  el13.setAttribute('aria-controls', 'lh-tools-locale__selector-wrapper');
  const el14 = dom.createElementNS("http://www.w3.org/2000/svg", "svg");
  el14.setAttribute('width', '20px');
  el14.setAttribute('height', '20px');
  el14.setAttribute('viewBox', '0 0 24 24');
  el14.setAttribute('fill', 'currentColor');
  const el15 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el15.setAttribute('d', 'M0 0h24v24H0V0z');
  el15.setAttribute('fill', 'none');
  const el16 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el16.setAttribute('d', 'M12.87 15.07l-2.54-2.51.03-.03c1.74-1.94 2.98-4.17 3.71-6.53H17V4h-7V2H8v2H1v1.99h11.17C11.5 7.92 10.44 9.75 9 11.35 8.07 10.32 7.3 9.19 6.69 8h-2c.73 1.63 1.73 3.17 2.98 4.56l-5.09 5.02L4 19l5-5 3.11 3.11.76-2.04zM18.5 10h-2L12 22h2l1.12-3h4.75L21 22h2l-4.5-12zm-2.62 7l1.62-4.33L19.12 17h-3.24z');
  el14.append(el15,el16);
  el13.append(" ",el14," ");
  const el17 = dom.createElement("div", "lh-tools-locale__selector-wrapper");
  el17.setAttribute('id', 'lh-tools-locale__selector-wrapper');
  el17.setAttribute('role', 'menu');
  el17.setAttribute('aria-labelledby', 'lh-button__swap-locales');
  el17.setAttribute('aria-hidden', 'true');
  el17.append(" "," ");
  el12.append(" ",el13," ",el17," ");
  const el18 = dom.createElement("button", "lh-tools__button");
  el18.setAttribute('id', 'lh-tools-button');
  el18.setAttribute('title', 'Tools menu');
  el18.setAttribute('aria-label', 'Toggle report tools menu');
  el18.setAttribute('aria-haspopup', 'menu');
  el18.setAttribute('aria-expanded', 'false');
  el18.setAttribute('aria-controls', 'lh-tools-dropdown');
  const el19 = dom.createElementNS("http://www.w3.org/2000/svg", "svg");
  el19.setAttribute('width', '100%');
  el19.setAttribute('height', '100%');
  el19.setAttribute('viewBox', '0 0 24 24');
  const el20 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el20.setAttribute('d', 'M0 0h24v24H0z');
  el20.setAttribute('fill', 'none');
  const el21 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el21.setAttribute('d', 'M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z');
  el19.append(" ",el20," ",el21," ");
  el18.append(" ",el19," ");
  const el22 = dom.createElement("div", "lh-tools__dropdown");
  el22.setAttribute('id', 'lh-tools-dropdown');
  el22.setAttribute('role', 'menu');
  el22.setAttribute('aria-labelledby', 'lh-tools-button');
  const el23 = dom.createElement("a", "lh-report-icon lh-report-icon--print");
  el23.setAttribute('role', 'menuitem');
  el23.setAttribute('tabindex', '-1');
  el23.setAttribute('href', '#');
  el23.setAttribute('data-i18n', 'dropdownPrintSummary');
  el23.setAttribute('data-action', 'print-summary');
  ...
  el24.setAttribute('data-i18n', 'dropdownPrintExpanded');
  el24.setAttribute('data-action', 'print-expanded');
  const el25 = dom.createElement("a", "lh-report-icon lh-report-icon--copy");
  el25.setAttribute('role', 'menuitem');
  el25.setAttribute('tabindex', '-1');
  el25.setAttribute('href', '#');
  el25.setAttribute('data-i18n', 'dropdownCopyJSON');
  el25.setAttribute('data-action', 'copy');
  const el26 = dom.createElement("a", "lh-report-icon lh-report-icon--download lh-hidden");
  el26.setAttribute('role', 'menuitem');
  el26.setAttribute('tabindex', '-1');
  el26.setAttribute('href', '#');
  el26.setAttribute('data-i18n', 'dropdownSaveHTML');
  el26.setAttribute('data-action', 'save-html');
  const el27 = dom.createElement("a", "lh-report-icon lh-report-icon--download");
  el27.setAttribute('role', 'menuitem');
  el27.setAttribute('tabindex', '-1');
  el27.setAttribute('href', '#');
  el27.setAttribute('data-i18n', 'dropdownSaveJSON');
  el27.setAttribute('data-action', 'save-json');
  const el28 = dom.createElement("a", "lh-report-icon lh-report-icon--open");
  el28.setAttribute('role', 'menuitem');
  el28.setAttribute('tabindex', '-1');
  el28.setAttribute('href', '#');
  el28.setAttribute('data-i18n', 'dropdownViewer');
  el28.setAttribute('data-action', 'open-viewer');
  ...
  el29.setAttribute('data-i18n', 'dropdownSaveGist');
  el29.setAttribute('data-action', 'save-gist');
  const el30 = dom.createElement("a", "lh-report-icon lh-report-icon--dark");
  el30.setAttribute('role', 'menuitem');
  el30.setAttribute('tabindex', '-1');
  el30.setAttribute('href', '#');
  el30.setAttribute('data-i18n', 'dropdownDarkTheme');
  el30.setAttribute('data-action', 'toggle-dark');
  el22.append(" ",el23," ",el24," ",el25," "," ",el26," ",el27," ",el28," ",el29," ",el30," ");
  el11.append(" ",el12," ",el18," ",el22," ");
  el2.append(" "," ",el3," ",el10," ",el11," ");
  el0.append(el2);
  return el0;
}

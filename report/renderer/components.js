...
function createClumpComponent(dom) {
  ...
  const el2 = dom.createElement('details', 'lh-clump lh-expandable-details');
  const el3 = dom.createElement('summary');

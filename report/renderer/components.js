...
function createHeadingComponent(dom) {
  ...
  el0.append(el1);
  const el2 = dom.createElement("div", "lh-header-inner");
...
function createScoresWrapperComponent(dom) {
  ...
  el0.append(el1);
  const el2 = dom.createElement("div", "lh-scores-container");
  const el3 = dom.createElement("div", "lh-pyro");
  const el4 = dom.createElement("div", "lh-before");
  const el5 = dom.createElement("div", "lh-after");
  el3.append(" ",el4," ",el5," ");
  el2.append(" ",el3," ");
  el0.append(el2);
  return el0;

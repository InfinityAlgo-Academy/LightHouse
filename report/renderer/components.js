...
function createTopbarComponent(dom) {
  ...
  el3.setAttribute('height', '48');
  el3.setAttribute('width', '48');
  el3.setAttribute('xmlns', 'http://www.w3.org/2000/svg');
  const el4 = dom.createElementNS("http://www.w3.org/2000/svg", "clipPath");
  el4.setAttribute('id', 'a');
  const el5 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el5.setAttribute('d', 'M0 0h48v48H0z');
  el4.append(" ",el5," ");
  const el6 = dom.createElementNS("http://www.w3.org/2000/svg", "g");
  el6.setAttribute('clip-path', 'url(#a)');
  const el7 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el7.setAttribute('d', 'M15 17.5V8.268a.5.5 0 0 1 .223-.416l8.5-5.667a.5.5 0 0 1 .554 0l8.5 5.667a.5.5 0 0 1 .223.416V17.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 1 .5.5v5a.5.5 0 0 1-.5.5h-2.905a.5.5 0 0 0-.493.586l3.796 22.828a.5.5 0 0 1-.493.586h-24.81a.5.5 0 0 1-.493-.586l3.796-22.828a.5.5 0 0 0-.493-.586H11.5a.5.5 0 0 1-.5-.5v-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 0 .5-.5z');
  el7.setAttribute('fill', '#f63');
  const el8 = dom.createElementNS("http://www.w3.org/2000/svg", "g");
  el8.setAttribute('fill', '#fff');
  el8.setAttribute('opacity', '.4');
  const el9 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el9.setAttribute('d', 'M21.07 48h-9.476a.5.5 0 0 1-.492-.586l.563-3.385L34.44 32.641l1.332 8.007zM31.058 24l-17.52 8.76 1.36-8.174a.5.5 0 0 0-.49-.586z');
  el8.append(" ",el9," ");
  const el10 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el10.setAttribute('d', 'M20 10.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5z');
  el10.setAttribute('fill', '#ff3');
  el6.append(" ",el7," ",el8," ",el10," ");
  el3.append(" ",el4," ",el6," ");
  const el11 = dom.createElement("a", "lh-topbar__url");
  el11.setAttribute('href', '');
  el11.setAttribute('target', '_blank');
  el11.setAttribute('rel', 'noopener');
  const el12 = dom.createElement("div", "lh-tools");
  const el13 = dom.createElement("div", "lh-tools-locale lh-hidden");
  const el14 = dom.createElement("button", "lh-button lh-tool-locale__button");
  el14.setAttribute('id', 'lh-button__swap-locales');
  el14.setAttribute('title', 'Show Language Picker');
  el14.setAttribute('aria-label', 'Toggle language picker');
  el14.setAttribute('aria-haspopup', 'menu');
  el14.setAttribute('aria-expanded', 'false');
  el14.setAttribute('aria-controls', 'lh-tools-locale__selector-wrapper');
  const el15 = dom.createElementNS("http://www.w3.org/2000/svg", "svg");
  el15.setAttribute('width', '20px');
  el15.setAttribute('height', '20px');
  el15.setAttribute('viewBox', '0 0 24 24');
  el15.setAttribute('fill', 'currentColor');
  const el16 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el16.setAttribute('d', 'M0 0h24v24H0V0z');
  el16.setAttribute('fill', 'none');
  const el17 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el17.setAttribute('d', 'M12.87 15.07l-2.54-2.51.03-.03c1.74-1.94 2.98-4.17 3.71-6.53H17V4h-7V2H8v2H1v1.99h11.17C11.5 7.92 10.44 9.75 9 11.35 8.07 10.32 7.3 9.19 6.69 8h-2c.73 1.63 1.73 3.17 2.98 4.56l-5.09 5.02L4 19l5-5 3.11 3.11.76-2.04zM18.5 10h-2L12 22h2l1.12-3h4.75L21 22h2l-4.5-12zm-2.62 7l1.62-4.33L19.12 17h-3.24z');
  el15.append(el16,el17);
  el14.append(" ",el15," ");
  const el18 = dom.createElement("div", "lh-tools-locale__selector-wrapper");
  el18.setAttribute('id', 'lh-tools-locale__selector-wrapper');
  el18.setAttribute('role', 'menu');
  el18.setAttribute('aria-labelledby', 'lh-button__swap-locales');
  el18.setAttribute('aria-hidden', 'true');
  el18.append(" "," ");
  el13.append(" ",el14," ",el18," ");
  const el19 = dom.createElement("button", "lh-tools__button");
  el19.setAttribute('id', 'lh-tools-button');
  el19.setAttribute('title', 'Tools menu');
  el19.setAttribute('aria-label', 'Toggle report tools menu');
  el19.setAttribute('aria-haspopup', 'menu');
  el19.setAttribute('aria-expanded', 'false');
  el19.setAttribute('aria-controls', 'lh-tools-dropdown');
  const el20 = dom.createElementNS("http://www.w3.org/2000/svg", "svg");
  el20.setAttribute('width', '100%');
  el20.setAttribute('height', '100%');
  el20.setAttribute('viewBox', '0 0 24 24');
  const el21 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el21.setAttribute('d', 'M0 0h24v24H0z');
  el21.setAttribute('fill', 'none');
  const el22 = dom.createElementNS("http://www.w3.org/2000/svg", "path");
  el22.setAttribute('d', 'M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z');
  el20.append(" ",el21," ",el22," ");
  el19.append(" ",el20," ");
  const el23 = dom.createElement("div", "lh-tools__dropdown");
  el23.setAttribute('id', 'lh-tools-dropdown');
  el23.setAttribute('role', 'menu');
  el23.setAttribute('aria-labelledby', 'lh-tools-button');
  const el24 = dom.createElement("a", "lh-report-icon lh-report-icon--print");
  el24.setAttribute('role', 'menuitem');
  el24.setAttribute('tabindex', '-1');
  el24.setAttribute('href', '#');
  el24.setAttribute('data-i18n', 'dropdownPrintSummary');
  el24.setAttribute('data-action', 'print-summary');
  const el25 = dom.createElement("a", "lh-report-icon lh-report-icon--print");
  el25.setAttribute('role', 'menuitem');
  el25.setAttribute('tabindex', '-1');
  el25.setAttribute('href', '#');
  el25.setAttribute('data-i18n', 'dropdownPrintExpanded');
  el25.setAttribute('data-action', 'print-expanded');
  const el26 = dom.createElement("a", "lh-report-icon lh-report-icon--copy");
  el26.setAttribute('role', 'menuitem');
  el26.setAttribute('tabindex', '-1');
  el26.setAttribute('href', '#');
  el26.setAttribute('data-i18n', 'dropdownCopyJSON');
  el26.setAttribute('data-action', 'copy');
  const el27 = dom.createElement("a", "lh-report-icon lh-report-icon--download lh-hidden");
  el27.setAttribute('role', 'menuitem');
  el27.setAttribute('tabindex', '-1');
  el27.setAttribute('href', '#');
  el27.setAttribute('data-i18n', 'dropdownSaveHTML');
  el27.setAttribute('data-action', 'save-html');
  const el28 = dom.createElement("a", "lh-report-icon lh-report-icon--download");
  el28.setAttribute('role', 'menuitem');
  el28.setAttribute('tabindex', '-1');
  el28.setAttribute('href', '#');
  el28.setAttribute('data-i18n', 'dropdownSaveJSON');
  el28.setAttribute('data-action', 'save-json');
  const el29 = dom.createElement("a", "lh-report-icon lh-report-icon--open");
  el29.setAttribute('role', 'menuitem');
  el29.setAttribute('tabindex', '-1');
  el29.setAttribute('href', '#');
  el29.setAttribute('data-i18n', 'dropdownViewer');
  el29.setAttribute('data-action', 'open-viewer');
  const el30 = dom.createElement("a", "lh-report-icon lh-report-icon--open");
  el30.setAttribute('role', 'menuitem');
  el30.setAttribute('tabindex', '-1');
  el30.setAttribute('href', '#');
  el30.setAttribute('data-i18n', 'dropdownSaveGist');
  el30.setAttribute('data-action', 'save-gist');
  const el31 = dom.createElement("a", "lh-report-icon lh-report-icon--dark");
  el31.setAttribute('role', 'menuitem');
  el31.setAttribute('tabindex', '-1');
  el31.setAttribute('href', '#');
  el31.setAttribute('data-i18n', 'dropdownDarkTheme');
  el31.setAttribute('data-action', 'toggle-dark');
  el23.append(" ",el24," ",el25," ",el26," "," ",el27," ",el28," ",el29," ",el30," ",el31," ");
  el12.append(" ",el13," ",el19," ",el23," ");
  el2.append(" "," ",el3," ",el11," ",el12," ");
  el0.append(el2);
  return el0;
}

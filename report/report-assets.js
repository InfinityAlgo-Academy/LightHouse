...
const REPORT_TEMPLATE = fs.readFileSync(__dirname + '/assets/psi-template.html', 'utf8');
const REPORT_JAVASCRIPT = fs.readFileSync(__dirname + '/../dist/report/psi-report.js', 'utf8');

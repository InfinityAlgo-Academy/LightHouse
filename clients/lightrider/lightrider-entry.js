...
const preprocessor = require('../../core/lib/proto-preprocessor.js');
const assetSaver = require('../../core/lib/asset-saver.js');

/** @type {Record<'mobile'|'desktop', LH.Config.Json>} */
const LR_PRESETS = {
  mobile: require('../../core/config/lr-mobile-config.js'),
  desktop: require('../../core/config/lr-desktop-config.js'),
};

  ...
  module LH {
    ...
    export module ResultLite {
      ...
      export interface Audit {
         ...
         * 'not_applicable': the audit turned out to not apply to the page. Score is null and should be ignored.
         ...
         */
        scoreDisplayMode: 'binary' | 'numeric' | 'informative' | 'not_applicable' | 'manual' | 'error';

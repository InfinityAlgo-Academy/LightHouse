...
describe('i18n', () => {
  ...
  describe('#replaceIcuMessages', () => {
    it('replaces the references in the LHR', () => {
      ...
      const expectedPathId = 'core/test/lib/i18n/fake-file-number-2.js | aString';
  ...
  describe('#registerLocaleData', () => {
    ...
    it('installs new locale strings', () => {
      const localeData = {
        'core/test/lib/i18n/i18n-test.js | testString': {
  ...
  describe('#isIcuMessage', () => {
    const icuMessage = {
      i18nId: 'core/test/lib/i18n/fake-file.js | title',
      values: {x: 1},

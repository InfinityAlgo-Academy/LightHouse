    ...
    networkRecords = [
      {
        ...
        networkEndTime: 3, rendererStartTime: 1,
        resourceType: 'Font',
      },
      {
        url: 'https://example.com/foo/font-b.woff',
        networkEndTime: 5, rendererStartTime: 1,
        resourceType: 'Font',
      },
      {
        url: 'https://example.com/foo/bar/font.woff',
        networkEndTime: 2, rendererStartTime: 1,
        resourceType: 'Font',
      },
    ];
  ...
  it('passes when all fonts have a correct font-display rule', async () => {
    ...
    networkRecords = [
      ...
      },
      {
        ...
        networkEndTime: 7, rendererStartTime: 1,
        resourceType: 'Font',
      },
    ];
    ...
    networkRecords = [
      {
        ...
        rendererStartTime: 1, networkEndTime: 5,
        resourceType: 'Font',
      },
      {

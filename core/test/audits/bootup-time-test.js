...
`);
  ...
  it('should compute the correct values when simulated', async () => {
    ...
    // TODO: Update the devtoolsLog with a modern Chrome. NetworkRecords is missing
    // the entry of https://pwa.rocks/0ff789bf.js but is present in traces,
    // thus missing entity classification for it.
    // https://github.com/GoogleChrome/lighthouse/issues/14525
    expect(output.details.items).toMatchInlineSnapshot(`
Array [
  Object {
    "entity": undefined,

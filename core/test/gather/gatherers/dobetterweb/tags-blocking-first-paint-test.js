...
const traceData = {
  networkRecords: [
    ...
    },
    {
      ...
      transferSize: 24,
      mainThreadStartTime: 24_000,
      networkEndTime: 24_000,
      mainThreadEndTime: 24_000,
      finished: true,
      isLinkPreload: false,
    ...
    },
    {
      ...
      mimeType: 'text/html',
      transferSize: 13,
      mainThreadStartTime: 13_000,
      networkEndTime: 13_000,
      mainThreadEndTime: 13_000,
      finished: true,
      isLinkPreload: false,
      initiator: {type: 'script'},
    },
    {
      ...
      mimeType: 'text/css',
      transferSize: 16,
      mainThreadStartTime: 16_000,
      networkEndTime: 16_000,
      mainThreadEndTime: 16_000,
      finished: true,
      isLinkPreload: true,
      initiator: {type: 'script'},
    },

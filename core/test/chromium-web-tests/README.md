...
#   run: bash $GITHUB_WORKSPACE/lighthouse/core/test/chromium-web-tests/run-web-tests.sh --reset-results
...
Simply make your changes in `.tmp/chromium-web-tests/blink_tools`, and run: `git -C .tmp/chromium-web-tests/blink_tools diff > core/test/chromium-web-tests/blink-tools.patch`

...
declare global {
  module LH {
    ...
    module Artifacts {
      ...
      export type Select<T extends typeof _Audit> = Pick<LH.Artifacts, T['requiredArtifacts'][number]> & Partial<Pick<LH.Artifacts, T['__internalOptionalArtifacts'][number]>>;

        ...
        },
        {
          ...
          inputs: [
            ...
            },
            {
              ...
              nodeLabel: 'input',
              snippet: '<input type="text" id="address_shipping" autocomplete="shippin street-address" placeholder="Your address" title="overall type: HTML_TYPE_STREET_ADDRESSnserver type: NO_SERVER_DATAnheurist…" autofill-information="overall type: HTML_TYPE_STREET_ADDRESSnserver type: NO_SERVER_DATAnheurist…" autofill-prediction="HTML_TYPE_STREET_ADDRESS">',
            },
            {
              id: 'city_shipping',
              name: '',

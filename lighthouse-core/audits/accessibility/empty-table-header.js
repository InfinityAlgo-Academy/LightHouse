...
const UIStrings = {
  /** Title of an accesibility audit that checks if there are any table headers without readable text. This title is descriptive of the successful state and is shown to users when no user action is required. */

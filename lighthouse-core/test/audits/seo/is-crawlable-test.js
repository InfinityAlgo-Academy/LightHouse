...
describe('SEO: Is page crawlable audit', () => {
  ...
  it('fails when page is blocked from indexing with a robots metatag', async () => {
    const robotsValues = [
      'noindex',
      'none',
      'foo, noindex, bar',
  ...
  it('succeeds when there are no blocking directives in the metatag', async () => {
    ...
    const artifacts = {
      devtoolsLogs: {[IsCrawlableAudit.DEFAULT_PASS]: devtoolsLog},
      URL: {mainDocumentUrl},
      requestMainResource: async () => Promise.resolve(mainResource),
  ...
  it('fails when page is blocked from indexing with a header', async () => {
    const robotsHeaders = [
      [
  ...
  it('fails when page is blocked from indexing by robots.txt', async () => {
    const robotsTxts = [
      {
        content: `User-agent: *
        Disallow: /`,
  ...
  it('succeeds when page is allowed by robots.txt', async () => {
    const robotsTxts = [
      {

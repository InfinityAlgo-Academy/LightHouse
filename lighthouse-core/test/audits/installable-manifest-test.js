...
describe('PWA: webapp install banner audit', () => {
  describe('basics', () => {
    ...
    it('passes when manifest url matches', async () => {
      const artifacts = generateMockArtifacts();
      const context = generateMockAuditContext();
    ...
    it('passes with complete manifest and SW', async () => {
      const context = generateMockAuditContext();
      const result = await InstallableManifestAudit.audit(generateMockArtifacts(), context);
  ...
  describe('one-off-failures', () => {
    it('fails when a manifest contains no start_url', async () => {
      const artifacts = generateMockArtifacts();
    ...
    it('fails when a manifest contains no name or short_name', async () => {
      const artifacts = generateMockArtifacts();
    ...
    it('fails if page had no fetchable icons in the manifest', async () => {
      const artifacts = generateMockArtifacts();
  ...
  describe('installability error handling', () => {
    it('fails when InstallabilityError doesnt have enough errorArguments', async () => {
      const artifacts = generateMockArtifacts();
      artifacts.InstallabilityErrors.errors.push({errorId: 'manifest-missing-suitable-icon',
        errorArguments: []});
      const context = generateMockAuditContext();
    ...
    it('fails when InstallabilityError contains too many errorArguments', async () => {
      const artifacts = generateMockArtifacts();
      artifacts.InstallabilityErrors.errors.push({errorId: 'manifest-missing-suitable-icon',
    ...
    it('fails when we receive an unknown InstallabilityError id', async () => {
      const artifacts = generateMockArtifacts();
    ...
    it('ignores in-incognito InstallabilityError', async () => {
      const artifacts = generateMockArtifacts();
  ...
  describe('warnings', () => {
    it('presents a warning if a warn-not-offline-capable if present', async () => {

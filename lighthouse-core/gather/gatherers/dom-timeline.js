...
/* global window, MutationObserver, document, getNodeDetails */
...
class DOMTimeline extends Gatherer {
  ...
  async beforePass(passContext) {
    return passContext.driver.executionContext.evaluateOnNewDocument(setupObserver, {
      args: [],
  ...
  async afterPass(passContext, loadData) {
    ...
    return await passContext.driver.executionContext.evaluate(getDomDetails, {
      args: [],
    });
  }
}
